...
from view import cronograma_viz
...
def main():
    while True:    
        ...
        if escolha == "2":
            cronograma_viz.exibir_cronograma() #Ver cronograma de compras
        if escolha == "3":
        ...
        if escolha == "5":
            save_point.exibir_movimentacoes() #Exibe o histórico de movimentações(quantos componentes foram comprados para tal produto e produtos foram pedidos)
        if escolha == "6":
